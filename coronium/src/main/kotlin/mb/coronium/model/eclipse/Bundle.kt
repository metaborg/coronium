...
data class Bundle(
    ...
    class Builder {
        ...
        fun readFromManifestAttributes(attributes: Attributes, log: Log): Builder {
            ...
            val sourceBundleFor =
                BundleDependency.readDependencyFromManifest(attributes, eclipseSourceBundleAttribute, log)
    ...
    fun writeToManifestAttributes(): Map<String, String> {
        ...
        if (sourceBundleFor != null) {
            BundleDependency.writeToDependencyManifestAttributes(
                sourceBundleFor,
                eclipseSourceBundleAttribute,
                attributes
            )
        }
        return attributes
...
data class BundleDependency(
    ...
    companion object {
            ...
            return if (requireBundleStr != null) {
                try {
                    ...
                    throw BundleParseException(
                        "Cannot read dependency from manifest, failed to parse $requireBundleAttribute '$requireBundleStr'",
                        e
                    )
                }
            } else {
        ...
        fun readDependencyFromManifest(attributes: Attributes, attributeName: String, log: Log): BundleDependency? {
            ...
            return if (value != null) {
                try {
                    ...
                    throw BundleParseException(
                        "Cannot read dependency from manifest, failed to parse $attributeName '$value'",
                        e
                    )
                }
            } else {
        ...
        fun writeToRequireBundleManifestAttributes(
            requiredBundles: Collection<BundleDependency>,
        ...
        fun writeToDependencyManifestAttributes(
