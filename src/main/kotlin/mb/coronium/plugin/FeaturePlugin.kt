...
class FeaturePlugin : Plugin<Project> {
  ...
  private fun configure(project: Project) {
      ...
      if(bundleRuntimeConfig.allDependencies.isEmpty()) {
        for(featureDependency in feature.dependencies) {
          ...
          if(!isMavenizedBundle) {
            ...
            project.bundleRuntimeClasspathConfig().dependencies.add(gradleDependency) // TODO: fix wrong configuration
          }
        }
      }
    }
    ...
    val featureXmlTask = project.tasks.create("featureXmlTask") {
      ...
      doLast {
        val mergedFeature = feature.mergeWith(project.bundleRuntimeClasspathConfig()) // TODO: fix wrong configuration
